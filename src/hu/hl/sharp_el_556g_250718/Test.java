...
public class Test {
	public static void run0(Calculator calculator) {
		"2+3r3=×".chars().forEach(i -> calculator.key((char) i)); //3
		"2*3r3=×".chars().forEach(i -> calculator.key((char) i)); //2
		"f1+e=======r2====×".chars().forEach(i -> calculator.key((char) i)); //22
		"2as8r4=×".chars().forEach(i -> calculator.key((char) i)); //1820
		
/*		"d03*d30=×".chars().forEach(i -> calculator.key((char) i)); //81.5374894915
		"10*d01=×".chars().forEach(i -> calculator.key((char) i)); //2.99792458E9
		"1048576=q/q2=×".chars().forEach(i -> calculator.key((char) i)); //20
		"fdd13f10*80d01as=×".chars().forEach(i -> calculator.key((char) i)); //
*/
		"f1+e==e==(6(7))==×".chars().forEach(i -> calculator.key((char) i)); //44
		"f3+e5+9=×".chars().forEach(i -> calculator.key((char) i)); //17
		"f3+e===6*8=×".chars().forEach(i -> calculator.key((char) i)); //51
		"1-e===e6*8==×".chars().forEach(i -> calculator.key((char) i)); //-47 -47 
		"2*e=3*5=×".chars().forEach(i -> calculator.key((char) i)); //30 
		"2*e=3+5=×".chars().forEach(i -> calculator.key((char) i)); //11
	...
	public static void run1(Calculator calculator) {
		"f2+3o+7=×".chars().forEach(i -> calculator.key((char) i)); //18
		"2+9+7=×".chars().forEach(i -> calculator.key((char) i)); //18
		"2+3o×".chars().forEach(i -> calculator.key((char) i)); //9
		"+7=×".chars().forEach(i -> calculator.key((char) i)); //18
		"5(2+3)=×".chars().forEach(i -> calculator.key((char) i)); //25
		"5*(2+3)=×".chars().forEach(i -> calculator.key((char) i)); //25
		"5/(2+3)=×".chars().forEach(i -> calculator.key((char) i)); //1
		"5o(2+3)=×".chars().forEach(i -> calculator.key((char) i)); //125
		"5o*(2+3)=×".chars().forEach(i -> calculator.key((char) i)); //125
		"5o/(2+3)=×".chars().forEach(i -> calculator.key((char) i)); //5
		"2(3(4(5(6(7(8))))))=×".chars().forEach(i -> calculator.key((char) i)); //40320
		"3+9)(5+7)=×".chars().forEach(i -> calculator.key((char) i)); //144
		"1+2*(3+4(5-6)(7-8))=×".chars().forEach(i -> calculator.key((char) i)); //15
		"8/2*15y/((5-8)-7)+9+6*3=×".chars().forEach(i -> calculator.key((char) i)); //33
		"1/(1/12+1/6)=×".chars().forEach(i -> calculator.key((char) i)); //4
		"((2+3)*8)=×".chars().forEach(i -> calculator.key((char) i)); //40
		"(2+3)(5+7)=×".chars().forEach(i -> calculator.key((char) i)); //60
		"(2)3)5)7)=×".chars().forEach(i -> calculator.key((char) i)); //7
		"(2+3)o(5+7)=×".chars().forEach(i -> calculator.key((char) i)); //300
		"(2+3)o×".chars().forEach(i -> calculator.key((char) i)); //25
		"(2)=×".chars().forEach(i -> calculator.key((char) i)); //50
		"(2+3)(5+7))(9)=×".chars().forEach(i -> calculator.key((char) i)); //540
		"(12ao+6ao)ao×".chars().forEach(i -> calculator.key((char) i)); //4
		"3as2f9=×".chars().forEach(i -> calculator.key((char) i)); //27
		"3asf8=×".chars().forEach(i -> calculator.key((char) i)); //8 helyett 24; nagyon macerás lenne megoldani
		"f(1+2)f×".chars().forEach(i -> calculator.key((char) i)); //0
		"(5f8+3f9)×".chars().forEach(i -> calculator.key((char) i)); //17
		"6oas=×".chars().forEach(i -> calculator.key((char) i)); //113.09733552923255
		"3f3+9f12*4f5=×".chars().forEach(i -> calculator.key((char) i)); //63
		"3=(9)=×".chars().forEach(i -> calculator.key((char) i)); //9
		"3=o(9)=×".chars().forEach(i -> calculator.key((char) i)); //81
		"12+(5*7))(11)=×".chars().forEach(i -> calculator.key((char) i)); //517
		"asas=×".chars().forEach(i -> calculator.key((char) i)); //9.869604401089358
		"2*15as=/as=×".chars().forEach(i -> calculator.key((char) i)); //30
		"4+3al=4+(5-(8-(5al)))=×".chars().forEach(i -> calculator.key((char) i)); //121
		"3+as8=×".chars().forEach(i -> calculator.key((char) i)); //11
		"6.48=-o12of12as=×".chars().forEach(i -> calculator.key((char) i)); //-31.219111843077517
		"4+5(9)y=×".chars().forEach(i -> calculator.key((char) i)); //-41
		"9=/(1+2)=×".chars().forEach(i -> calculator.key((char) i)); //3
		"3+(5-()7))=×".chars().forEach(i -> calculator.key((char) i)); //1
		"3+(8+(llee0lf×".chars().forEach(i -> calculator.key((char) i)); //( _
		"f2+7+5l=×".chars().forEach(i -> calculator.key((char) i)); //9.45
		"2+(7*5)l=×".chars().forEach(i -> calculator.key((char) i)); //2.7
		"2+(7*5*11)l=×".chars().forEach(i -> calculator.key((char) i)); //9.7
		"2+7*5l=×".chars().forEach(i -> calculator.key((char) i)); //2.35
		"2*7*5l=×".chars().forEach(i -> calculator.key((char) i)); //0.7
		"5+5l=×".chars().forEach(i -> calculator.key((char) i)); //5.25
		"6+l=×".chars().forEach(i -> calculator.key((char) i)); //+_
		"f6+8l=×".chars().forEach(i -> calculator.key((char) i)); //6.48
		"1+8*al9=×".chars().forEach(i -> calculator.key((char) i)); //73
		"lllf2+3l=f2*9l=×".chars().forEach(i -> calculator.key((char) i)); //0.18
		"n(7+9)=×".chars().forEach(i -> calculator.key((char) i)); //6.788225099390856
		"f3n16=×".chars().forEach(i -> calculator.key((char) i)); //12
		"f3+2n16=×".chars().forEach(i -> calculator.key((char) i)); //11
		"fn16=×".chars().forEach(i -> calculator.key((char) i)); //4
		"f49=n=×".chars().forEach(i -> calculator.key((char) i)); //7
		"f3=n64=×".chars().forEach(i -> calculator.key((char) i)); //8
		"f5+n16=×".chars().forEach(i -> calculator.key((char) i)); //9
		"9n9=×".chars().forEach(i -> calculator.key((char) i)); //27
		"(2+3)n(2*67+5*7)=×".chars().forEach(i -> calculator.key((char) i)); //65
		"9=n=×".chars().forEach(i -> calculator.key((char) i)); //3
		"fn8=×".chars().forEach(i -> calculator.key((char) i)); //2.8284271247461903
		"*n8=×".chars().forEach(i -> calculator.key((char) i)); //8.000000000000002
		"f.0625=×".chars().forEach(i -> calculator.key((char) i)); //0.0625
		"nao=×".chars().forEach(i -> calculator.key((char) i)); //4
		"an8000=×".chars().forEach(i -> calculator.key((char) i)); //20
		"fm8=×".chars().forEach(i -> calculator.key((char) i)); //0
		"fam8=×".chars().forEach(i -> calculator.key((char) i)); //Er2
		"f(7+2)mn64=×".chars().forEach(i -> calculator.key((char) i)); //43046721
		"4aoam(3-8)=×".chars().forEach(i -> calculator.key((char) i)); //625
		"3+m2(2m3)=×".chars().forEach(i -> calculator.key((char) i)); //72
		"f33-y7=×".chars().forEach(i -> calculator.key((char) i)); //40
		"2asn(10sy6*100sy9)=ao×".chars().forEach(i -> calculator.key((char) i)); //159154.94309189534
		"3asf×".chars().forEach(i -> calculator.key((char) i)); //0.0 helyett (*)_ ; nagyon macerás lenne megoldani
		"f8=aq=×".chars().forEach(i -> calculator.key((char) i)); //2980.9579870417283
		"agj8ao=×".chars().forEach(i -> calculator.key((char) i)); //0.125657214
		"agj8=×".chars().forEach(i -> calculator.key((char) i)); //Er2
		"f9ac×".chars().forEach(i -> calculator.key((char) i)); //0.15707963267948966
		"ac×".chars().forEach(i -> calculator.key((char) i)); //10
		"ac×".chars().forEach(i -> calculator.key((char) i)); //9
		"fh(9*10)=×".chars().forEach(i -> calculator.key((char) i)); //1
		"fai2ao=×".chars().forEach(i -> calculator.key((char) i)); //60
		"5-6mn144*.25=×".chars().forEach(i -> calculator.key((char) i)); //-5.44195579E8
		"casacac×".chars().forEach(i -> calculator.key((char) i)); //180
		"chas/2=×".chars().forEach(i -> calculator.key((char) i)); //0
		"(3+3)as=×".chars().forEach(i -> calculator.key((char) i)); //18.84955592153876
		"ias/2=×".chars().forEach(i -> calculator.key((char) i)); //-0.4451861444787497
		"i(as/2)=×".chars().forEach(i -> calculator.key((char) i)); //1.4176916294081123
		"fi(as/2)=×".chars().forEach(i -> calculator.key((char) i)); //0
		"fai(n3/2)=acac×".chars().forEach(i -> calculator.key((char) i)); //30
		"cfiasas=×".chars().forEach(i -> calculator.key((char) i)); //-0.902685362
		"fias5=×".chars().forEach(i -> calculator.key((char) i)); //0.28366218546322625
		"f3=asagi=×".chars().forEach(i -> calculator.key((char) i)); //acosh_
		"f9=n(9)=×".chars().forEach(i -> calculator.key((char) i)); //27
		"f3=agi(2)=×".chars().forEach(i -> calculator.key((char) i)); //3.525494348078172
		"f3=agias=×".chars().forEach(i -> calculator.key((char) i)); //2.933662920962394
		"fcchnan729000000=×".chars().forEach(i -> calculator.key((char) i)); //0.5
/**/				
	}
	public static void run2(Calculator calculator) {
	...
	public static void run3(Calculator calculator) {
