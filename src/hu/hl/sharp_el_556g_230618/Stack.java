...
public class Stack implements ILong {
	private Base base= Base.D;
	public java.util.Stack<Operand> operand= new java.util.Stack<Operand>();
	public java.util.Stack<Integer> operator= new java.util.Stack<Integer>();
	private int pl;
	public Stack() {
		
	}
	public void push(Operand operand, int operator) {
